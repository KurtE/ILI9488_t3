...
//=============================================================================
// Connection configuration of ILI9488 LCD TFT
//=============================================================================
...
#define TABLET_DATA_X 100
      int16_t x, y2;
      unsigned char line_space = ComicSansMS_12.line_space;
      ...
      tft.getCursor(&x, &y2);
      tft.fillRect(x, y, 320, line_space, ILI9488_BLACK);
...
void OutputNumberField(int16_t x, int16_t y, int val, int16_t field_width) {
  ...
  tft.fillRect(x2, y, field_width - (x2 - x), ComicSansMS_12.line_space, ILI9488_BLACK);
}
...
bool OnReceiveHidData(uint32_t usage, const uint8_t *data, uint32_t len) {
  ...
  if (usage == 0xFF000080
    ...
    if (something_changed) {
      tft.fillRect(45, 197, 240, 20, ILI9488_RED);
